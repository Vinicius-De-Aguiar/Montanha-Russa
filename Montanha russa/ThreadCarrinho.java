...
public class ThreadCarrinho implements Runnable {
    Semaphore sem;
    ...
    public ThreadCarrinho(String nome, String ED, Semaphore sem) {
    ...
    public void run() {
        ...
        int min = 0;
        int max = 0;
        long calcmin = 0;//calculo minimo da rodada
        long auxcalcmin = 500000000;//calculo minimo
        long calcmax = 0;//calculo maximo da rodada
        long auxcalcmax = 0;//calculo maximo
        long TMV = 0;//tempo movimentando
        long TT = 0;//tempo total
        long TU;//tempo utilizado
